...
struct WBApp_WidgetSmallView: View {
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            .widgetURL(URL(string: "myapp://contactdetails?initials=\(entry.contactToDisplay[entry.currentContactIndex].name.initials)&creationDate=\(entry.contactToDisplay[entry.currentContactIndex].creationDate.string)")!)
        }
    }
}
