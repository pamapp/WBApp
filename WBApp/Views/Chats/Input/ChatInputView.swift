...
extension ChatInputView {
    private enum Constants {
        ...
        static var textFieldPadding: CGFloat = 8
        static var buttonVerticalPadding: CGFloat = 6
        static var replyPadding: CGFloat = 16
        static var mainVerticalPadding: CGFloat = 10
    }
}
