...
extension VerificationScreen {
    ...
    private var countryPicker: some View {
        ...
        .countryPickerStyle(height: containerSize.adaptiveVerticalPadding(36),
                            flag: CountryCodesProvider.flag(for: selectedCountry),
                            code: CountryCodesProvider.phoneCode(for: selectedCountry))
    }
    ...
    private var phoneTextField: some View {
        ...
        .textFieldStyle(PhoneFieldStyle(height: containerSize ~ 36))
